        ...
        child: Column(
          children: [
            ClipRRect(
              ...
              child: Image.asset(portfolioImgPath,
                  width: double.infinity, height: 87, fit: BoxFit.cover, alignment: Alignment.topCenter,),
            ),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(profession,
                        style:
                            const TextStyle(color: Color(0xFF707070), fontSize: 11)),
                    Text(rating, style: const TextStyle(fontSize: 11)),
                    Text("From Rs.$hourlyRate/hr", style: const TextStyle(fontSize: 11)),
                  ],
                ),
