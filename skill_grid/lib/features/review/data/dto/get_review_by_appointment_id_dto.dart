...
part 'get_review_by_appointment_id_dto.g.dart';

@JsonSerializable()
class GetReviewByAppointmentIdDto {
  @JsonKey(name: '_id')
  ...
  factory GetReviewByAppointmentIdDto.fromJson(Map<String, dynamic> json) =>
      _$GetReviewByAppointmentIdDtoFromJson(json);

  Map<String, dynamic> toJson() => _$GetReviewByAppointmentIdDtoToJson(this);
}