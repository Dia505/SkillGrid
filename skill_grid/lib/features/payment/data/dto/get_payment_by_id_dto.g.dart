...
part of 'get_payment_by_id_dto.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetPaymentByIdDto _$GetPaymentByIdDtoFromJson(Map<String, dynamic> json) =>
    GetPaymentByIdDto(
...
Map<String, dynamic> _$GetPaymentByIdDtoToJson(GetPaymentByIdDto instance) =>
    <String, dynamic>{
