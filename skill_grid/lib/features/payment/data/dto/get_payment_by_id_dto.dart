...
part 'get_payment_by_id_dto.g.dart';
...
class GetPaymentByIdDto {
  ...
  factory GetPaymentByIdDto.fromJson(Map<String, dynamic> json) =>
      _$GetPaymentByIdDtoFromJson(json);

  Map<String, dynamic> toJson() => _$GetPaymentByIdDtoToJson(this);
}