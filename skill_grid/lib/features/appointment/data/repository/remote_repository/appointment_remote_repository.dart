...
class AppointmentRemoteRepository implements IAppointmentRepository {
  ...
  Future<Either<Failure, AppointmentEntity>> getAppointmentById(
      String appointmentId, String? token) async {
    try {
      final appointment = await _appointmentRemoteDataSource.getAppointmentById(
          appointmentId, token);
  ...
  Future<Either<Failure, String>> saveAppointment(
    ...
    try {
      String appointmentId = await _appointmentRemoteDataSource.saveAppointment(
          appointmentEntity, token);
  ...
  Future<Either<Failure, void>> updateAppointment(String appointmentId,
    ...
    try {
      await _appointmentRemoteDataSource.updateAppointment(
