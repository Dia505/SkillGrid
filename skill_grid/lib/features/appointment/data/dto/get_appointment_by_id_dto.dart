...
part 'get_appointment_by_id_dto.g.dart';

@JsonSerializable()
class GetAppointmentByIdDto {
  @JsonKey(name: "_id")
  ...
  factory GetAppointmentByIdDto.fromJson(Map<String, dynamic> json) =>
      _$GetAppointmentByIdDtoFromJson(json);

  Map<String, dynamic> toJson() => _$GetAppointmentByIdDtoToJson(this);
}