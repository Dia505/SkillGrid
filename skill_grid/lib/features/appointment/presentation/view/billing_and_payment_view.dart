  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ThemeBloc, ThemeState>(
      builder: (context, themeState) {
        ...
        Color hourlyRate = themeState.isDarkMode
            ? const Color(0XFF8984F2)
                ...
                child: Column(
                  children: [
                    const Text(
                      "Billing and Payment",
                      style:
                          TextStyle(fontSize: 20, fontFamily: "Inter SemiBold"),
                    ),
                    const SizedBox(
                      height: 20,
                    ),
                    ...
                    AppointmentFreelancerCard(
                      freelancerProfileImgPath:
                          widget.freelancer.profilePicture!,
                      freelancerName:
