...
part 'get_notification_by_id_dto.g.dart';

@JsonSerializable()
class GetNotificationByIdDto {
  @JsonKey(name: "_id")
  ...
  factory GetNotificationByIdDto.fromJson(Map<String, dynamic> json) =>
      _$GetNotificationByIdDtoFromJson(json);

  Map<String, dynamic> toJson() => _$GetNotificationByIdDtoToJson(this);
}